# -*- coding: utf-8 -*-
"""
Created on Tue Dec 29 09:51:14 2020
...
from keras.layers import Conv2D, MaxPooling2D, Flatten, Dense, AveragePooling2D, LSTM, Input
...
# %%
in1 = Input(shape=(28,28))

# %% LSTM and output
lstm_1 = LSTM(60, return_sequences = True)(in1)
print(lstm_1.shape)
