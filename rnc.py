# -*- coding: utf-8 -*-
"""
Created on Wed May 27 21:46:47 2020
drive end fault at 0hp, 1hp, 2hp and 3hp, 0.021in, 12ksps and 48ksps
@author: caiom
"""
...
def generate_images(df, overlap):

    slices = util.view_as_windows(df, window_shape=(N, ), step=N-overlap)
    ...
    for slice in slices:
        ...
        for x in range(0, len(fftsl)):
            T.append((np.log2(fftsl[x]/img_length)))
        T = np.asarray(T)
