# -*- coding: utf-8 -*-
"""
Created on Sun Dec 20 09:35:06 2020
...
from keras.layers import Conv2D, MaxPooling2D, Flatten, Dense, AveragePooling2D, Embedding, LSTM
...
# %%
from keras.layers import LSTM, Input, Conv1D, Dense, Reshape, MaxPooling1D, AveragePooling1D, Multiply, Permute
...
# %% LSTM and output
lstm_1 = LSTM(60, return_sequences = True)(fused)
print(lstm_1.shape)
lstm_2 = LSTM(30)(lstm_1)
print(lstm_2.shape)
output = Dense(6, activation='softmax')(lstm_2)

# %% LSTM and output
lstm_3 = LSTM(60, return_sequences = True)(in2)
print(lstm_3.shape)
lstm_4 = LSTM(30)(lstm_3)
print(lstm_2.shape)
output2 = Dense(6, activation='softmax')(lstm_4)

# %% build model
model_cnn_1 = Model(inputs=in1, outputs=pooling_1_reshape)
model_cnn_2 = Model(inputs=in1, outputs=pooling_3_reshape)
model_cnn = Model(inputs=in1, outputs=fused)
model_lstm = Model(inputs=in2, outputs=output2)
...
# %% fit
history= model.fit(Sl_train, y_train2, validation_data=(Sl_test, y_test2),
