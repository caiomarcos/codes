...
# %% classifier
conv_7 = Conv2D(16, (3, 3), activation='relu')(fused)
pooling_4 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_7)
conv_8 = Conv2D(32, (3, 3), activation='relu')(pooling_4)
pooling_5 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2))(conv_8)
flat_1 = Flatten()(pooling_5)
