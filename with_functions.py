# -*- coding: utf-8 -*-
"""
Created on Thu Jun  4 21:15:46 2020
...
def import_and_resize(path, title, sample_sizes):
    dataset_orig = scipy.io.loadmat(path)
    dataset_orig = dataset_orig[title]
    dataset_rs = []
    for size in sample_sizes:
        dataset_rs.append(scipy.signal.resample(dataset_orig, size))
    return (dataset_orig, dataset_rs)


# %%
# to generate the images for each class
...
# plot last image
    It = Img
    It.shape = (It.size//img_h, img_h)
    plt.imshow(It, cmap=style)
    plt.show()
    return M


# %%
paths = ['./48ksps/0hp/97.mat', ]
...
#     # fft
#     # set y size
#     y = inner_race_48_0hp_rs[(i*N):((i+1)*N)]
#     # reshape
#     y = y.reshape(N,)
#     # get fft
#     yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = inner_race_48_1hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = inner_race_48_2hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = inner_race_48_3hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
#     # fft
#     # set y size
#     y = outer_race_at3_48_0hp_rs[(i*N):((i+1)*N)]
#     # reshape
#     y = y.reshape(N,)
#     # get fft
#     yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at3_48_1hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at3_48_2hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at3_48_3hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
#     # fft
#     # set y size
#     y = outer_race_at6_48_0hp_rs[(i*N):((i+1)*N)]
#     # reshape
#     y = y.reshape(N,)
#     # get fft
#     yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at6_48_1hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at6_48_2hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at6_48_3hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
#     # fft
#     # set y size
#     y = outer_race_at12_48_0hp_rs[(i*N):((i+1)*N)]
#     # reshape
#     y = y.reshape(N,)
#     # get fft
#     yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at12_48_1hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at12_48_2hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
...
for i in range(0, samples_per_class):
    # fft
    # set y size
    y = outer_race_at12_48_3hp_rs[(i*N):((i+1)*N)]
    # reshape
    y = y.reshape(N,)
    # get fft
    yf = fft(y)
